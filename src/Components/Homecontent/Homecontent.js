                                    ...
                                    <div className="home_content ">
                                        ...
                                        <div className="about pa2 bg-white">
                                            ...
                                            <div className='about_profile_div '>
                                                <img alt='a' className="home_face" src={Face1} />
                                                ...
                                                <img alt='a' className="home_face" src={Face2} />
                                                <div className="about_profile">
                                                ...
                                                <img alt='a' className="home_face" src={Face3} />
                                                <div className="about_profile">
                                        ...
                                        <footer className='footer'>
                                            <div className='modified_left_div'>
                                                <div className='footer_leftdiv w-100'>
                                                    <img alt='a' className='logo2 mt3' src={Logo} />
                                                ...
                                                <div className='share_div'>
                                                    <img alt='a' className='share_link' src={Twitter}/>
                                                    <img alt='a' className='share_link' src={Facebook}/>
                                                </div>
                                            </div>
                                            <div className=' w-100 b--black footer_rightdiv'>
                                                <Link to="/location" exact target="_blank">
                                                    <img alt='a' className="location" target="_blank" src={Location} />
                                                </Link>
                                            </div>
